...
first_page <- tabPanel(
  ...
  fillPage(
    ...
    p("Mental health is a topic that is ever prevalent in our society,
      ...
      , br(), br(), "2. Which states have facilities that provide services for disabled 
...
fifth_page <- tabPanel(
  ...
  fillPage(
    ...
    "1. For all three of our charts, California and New York had the 
      ...
      population has more options in terms of facilities.", br(), br(),
