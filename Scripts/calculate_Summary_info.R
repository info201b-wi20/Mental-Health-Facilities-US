...
get_summary_info <- function(mental_health_resources) {
  ...
  state_highest_resources <- mental_health_resources %>%
  ...
  facilities_with_sign_language <- mental_health_resources %>%
    ...
    pull()
  ret <- list(
    total = total_mental_health_facilities, most_resources =
      state_highest_resources, washington = washington_facilities,
