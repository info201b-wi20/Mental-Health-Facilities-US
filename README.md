...
1.
2. Are there differences in quality of mental health care facilities between states?
...
1. The statistics of the N-MHSS-2018 data set has 11683 rows
2. The dataset from the Connecticut Mental Health Survey has "" rows
3. The statistics of the National Veteran Health Equity Report has "" rows

How many features (columns) are in the data?
1. The statistics of the N-MHSS-2018 data set has 254 rows
2.
3.
