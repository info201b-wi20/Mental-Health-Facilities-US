...
# You should write functions that take in your dataset as a parameter, and
# return a visualization of that data.
# This will allow you to call your charting function from your index.Rmd file,
# keeping your code much easier to read and update.
# Create a separate .R file for each chart.

# Each function must return a different type of visualization (e.g., you can
# only create one Scatter Plot).
# Again, in your report you must describe why you included the chart (e.g.,
...
# For the data, we used a data table that is essentially a summary table of
